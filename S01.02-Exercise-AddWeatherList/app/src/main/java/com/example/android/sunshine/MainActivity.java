...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView weather = (TextView) findViewById(R.id.tv_weather_data);
        // DONE (3) Create an array of Strings that contain fake weather data
        String[] fakeWeatherData = {"Sunny", "Cloudy", "Rainy"};
        // DONE (4) Append each String from the fake weather data array to the TextView
        for (String weatherD : fakeWeatherData){
            weather.append(weatherD+"\n \n \n");
        }
    }
}